...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { author_id: @deck.author_id, description: @deck.description, title: @deck.title }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { author_id: @deck.author_id, description: @deck.description, title: @deck.title }
    assert_redirected_to deck_path(assigns(:deck))
  end
